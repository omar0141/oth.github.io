...
import 'package:shakosh/Screens/Home/Components/Body.dart';
                  ...
                  Row(
                    children: [
                      Text(
                        ...
                        style: TextStyle(
                          color: (MyApi.username != "")
                              ? colors(context).grey1
                              : colors(context).normalTextColor,
                          fontSize: (MyApi.username != "") ? 14 : 18,
                          fontWeight: (MyApi.username != "")
                              ? FontWeight.normal
                              : FontWeight.bold,
                        ),
                      ),
